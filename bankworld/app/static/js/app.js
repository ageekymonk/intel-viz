...
(function() {
  'use strict';
  var BWDashboard, BWMap, BWMapVirus, BWReportMap, BWSpreadMap, DifferenceChart, MultiLineChart, MultiTimeSeriesChart, MultiTimeSeriesPolicyChart, b,
    ...
    BWSpreadMap.prototype.draw = function() {
      return d3.csv('/static/csv/branch_lat_long.csv').get((function(_this) {
        return function(error, world) {
          ...
          }).style("stroke", "black").attr("fill", "white").text(function(d) {
            return d.businessunit;
          }).on("click", function(d) {
            return _this.evDispatch.selectRegion(d.businessunit);
          });
          return d3.select(self.frameElement).style("height", _this.height + "px");
  ...
  MultiTimeSeriesChart = (function() {
    ...
    MultiTimeSeriesChart.prototype.draw = function(region, activityflag, data) {
      ...
      svg.selectAll('circle').on("mouseover.tooltip", (function(_this) {
        return function(d) {
      ...
      svg.selectAll('circle').on("mouseout.tooltip", (function(_this) {
        return function(d) {
      ...
      svg.append("g").attr("class", "x axis").attr("transform", "translate(0," + this.height + ")").call(xAxis);
      svg.append("g").attr("class", "y axis").call(yAxis).append("text").attr("transform", "rotate(-90)").attr("y", 6).attr("dy", ".71em").style("text-anchor", "end");
      return svg.append("text").attr("x", this.width / 2).attr("y", 0 - (this.margin.top / 2)).attr("text-anchor", "middle").style("font-size", "12px").text("Activity " + activityflag);
    };
  ...
  BWDashboard = (function() {
    ...
    BWDashboard.prototype.setupPlots = function() {
      ...
      this.bw_ws_teller_conn_chart = new MultiLineChart(560, 200, "#bw_ws_teller_conn_chart", "Teller Machine Connections");
      this.evdispatch.on("selectRegion.bw_ws_teller_conn_chart", (function(_this) {
        return function(region) {
          return _this.bw_ws_teller_conn_chart.draw(region);
        };
      })(this));
      this.evdispatch.on("selectTime.bw_ws_teller_conn_chart", (function(_this) {
        return function(start, end) {
          return _this.bw_ws_teller_conn_chart.draw(null, null, start, end);
        };
      })(this));
      this.bw_ws_loan_conn_chart = new MultiLineChart(560, 200, "#bw_ws_loan_conn_chart", "Loan Machine Connections");
      this.evdispatch.on("selectRegion.bw_ws_loan_conn_chart", (function(_this) {
        return function(region) {
          return _this.bw_ws_loan_conn_chart.draw(region);
        };
      })(this));
      this.evdispatch.on("selectTime.bw_ws_loan_conn_chart", (function(_this) {
        return function(start, end) {
          return _this.bw_ws_loan_conn_chart.draw(null, null, start, end);
        };
      })(this));
      this.bw_ws_office_conn_chart = new MultiLineChart(560, 200, "#bw_ws_office_conn_chart", "Office Machine Connections");
      this.evdispatch.on("selectRegion.bw_ws_office_conn_chart", (function(_this) {
        return function(region) {
          return _this.bw_ws_office_conn_chart.draw(region);
        };
      })(this));
      this.evdispatch.on("selectTime.bw_ws_office_conn_chart", (function(_this) {
        return function(start, end) {
          return _this.bw_ws_office_conn_chart.draw(null, null, start, end);
        };
      })(this));
      this.bw_activity_chart = new MultiTimeSeriesChart(760, 200, "#bw_activity_chart", "Activity Flag", this.evdispatch);
      this.evdispatch.on("selectRegion.activity", (function(_this) {
        return function(region) {
          return _this.bw_activity_chart.draw(region);
        };
      })(this));
      this.bw_policy_chart = new MultiTimeSeriesPolicyChart(760, 200, "#bw_policy_chart", "Policy Flag", this.evdispatch);
    ...
    BWDashboard.prototype.loadData = function() {
      ...
      d3.csv('/static/csv/ws_teller_connection.csv', (function(_this) {
        return function(error, data) {
          return _this.bw_ws_teller_conn_chart.draw("headquarters", data);
        };
      })(this));
      d3.csv('/static/csv/ws_loan_connection.csv', (function(_this) {
        return function(error, data) {
          return _this.bw_ws_loan_conn_chart.draw("headquarters", data);
        };
      })(this));
      d3.csv('/static/csv/ws_office_connection.csv', (function(_this) {
        return function(error, data) {
          return _this.bw_ws_office_conn_chart.draw("headquarters", data);
        };
      })(this));
