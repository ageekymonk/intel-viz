...
(function() {
  'use strict';
  var BWDashboard, BWMap, BWMapVirus, BWReportMap, DifferenceChart, MultiLineChart, MultiTimeSeriesPolicyChart, b,
  ...
  MultiTimeSeriesPolicyChart = (function() {
    ...
    MultiTimeSeriesPolicyChart.prototype.draw = function(region) {
      ...
      svg.append("g").attr("class", "x axis").attr("transform", "translate(0," + this.height + ")").call(xAxis);
      svg.append("g").attr("class", "y axis").call(yAxis);
      return canvas.append("text").attr("transform", "translate(0,30) rotate(-90)").attr("y", 10).attr("dy", ".71em").style("text-anchor", "end").text("Machine Count");
    };
