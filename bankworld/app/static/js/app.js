...
(function() {
  ...
  HeatMap = (function() {
    function HeatMap(w, h, parent, title, evDispatch) {
      ...
      this.maxtime = '2012-02-02 14:00:00';
      this.tmin = 0.2;
      this.tmax = 1;
      this.colPick = ['act5'];
      this.scales = {};
    ...
    HeatMap.prototype.draw = function(start_time, end_time, timecount) {
            ...
            return function(d) {
              if (_this.colPick[i] === 'erspread') {
                if (+d[_this.colPick[i]] > 0) {
                  return _this.scales['erspreadmax']((+d[_this.colPick[i]]) / d.sizepol);
                } else {
                  return _this.scales['erspreadmin']((+d[_this.colPick[i]]) / d.sizepol);
                }
              } else {
      ...
      }).selectAll('text').style("text-anchor", "right").attr("transform", "translate(" + (-this.rectWidth / 1.5) + ") rotate(-90)");
