...
(function() {
  'use strict';
  var BWDashboard, BWMap, BWMapVirus, BWReportMap, DifferenceChart, MultiLineChart, MultiTimeSeriesPolicyChart, WsConnectionsChart, b,
  ...
  WsConnectionsChart = (function() {
    ...
    WsConnectionsChart.prototype.draw = function(region) {
      ...
      svg.append("g").attr("class", "x axis").attr("transform", "translate(0," + this.height + ")").call(xAxis);
      svg.append("g").attr("class", "y axis").call(yAxis);
      return canvas.append("text").attr("transform", "translate(0,30) rotate(-90)").attr("y", 10).attr("dy", ".71em").style("text-anchor", "end").text("Average Connections");
    };
  ...
  BWDashboard = (function() {
    ...
    BWDashboard.prototype.setupPlots = function() {
      ...
      this.bw_ws_conn_chart = new WsConnectionsChart(760, 200, "#bw_ws_teller_conn_chart", "Teller Machine Connections");
